...
import { AutomatedSettlements } from "@/components/automated-settlements"
import { ExecutionTimeline } from "@/components/execution-timeline"
import { ESGImpactScore } from "@/components/esg-impact-score"
import { AIRiskAnalysis } from "@/components/ai-risk-analysis"
import { MNEEHeaderWidget } from "@/components/mnee-header-widget"
import { SmartSettlement } from "@/components/smart-settlement"
...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen">
      <Header />
      <div className="sticky top-16 z-40 w-full bg-background border-b border-border">
        <div className="container max-w-7xl px-6 py-3">
          <MNEEHeaderWidget />
        </div>
      </div>
      ...
      <div className="flex">
        ...
        <main className="ml-64 flex-1 p-6">
          <div className="container max-w-7xl">
            ...
            {activeSection === "settlements" && <AutomatedSettlements data={loanData} />}
            {activeSection === "execution" && <ExecutionTimeline data={loanData} />}
            {activeSection === "esg" && <ESGImpactScore data={loanData} />}
            {activeSection === "risk-analysis" && <AIRiskAnalysis data={loanData} />}
          </div>
        </main>
      </div>
